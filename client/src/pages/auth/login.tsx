        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <Input id="email" placeholder="name@example.com" className="h-12 bg-gray-50 border-gray-200" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input id="password" type="password" className="h-12 bg-gray-50 border-gray-200" />
            </div>

            <Button className="w-full h-12 bg-green-600 hover:bg-green-700 text-lg font-bold">Continue</Button>
